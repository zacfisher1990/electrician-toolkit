...
// Handle viewing a specific estimate from Jobs page
useEffect(() => {
  if (pendingEstimateData?.viewEstimateId) {
    const estimate = estimates.find(e => e.id === pendingEstimateData.viewEstimateId);
    if (estimate) {
      startEdit(estimate);
    }
