...
// Motor Branch Circuit Protection Calculator Component
const MotorProtectionCalculator = ({ protectionData, setProtectionData, colors }) => {
...
const MotorWireSizeCalculator = ({ wireSizeData, setWireSizeData, colors }) => {
...
const MotorCalculations = forwardRef(({ isDarkMode = false }, ref) => {
  ...
  const calculatorComponents = {
    flc: <MotorFLCCalculator flcData={flcData} setFlcData={setFlcData} colors={colors} />,
    protection: <MotorProtectionCalculator protectionData={protectionData} setProtectionData={setProtectionData} colors={colors} />,
    wiresize: <MotorWireSizeCalculator wireSizeData={wireSizeData} setWireSizeData={setWireSizeData} colors={colors} />
  };
