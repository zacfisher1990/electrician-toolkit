...
import { Info, Plus, Trash2, Calculator, FileDown, Briefcase, GitFork } from 'lucide-react';
...
const OhmsLawParallel = ({ isDarkMode, onExport }) => {
  ...
  return (
    <div>
      {/* Info Box */}
      <InfoBox type="warning" icon={Info} isDarkMode={isDarkMode}>
      ...
      >
        <div style={{ 
          ...
          {['V', 'I', 'R', 'P'].map(field => {
            ...
            const disabled = isTotalFieldDisabled(parallelTotals, field);
      ...
      >
        <div style={{ 
          ...
          <ResultCard
            label="Voltage"
            value={getTotalsParallel().totalV.toFixed(1)}
            unit="V"
            variant="subtle"
            isDarkMode={isDarkMode}
          />
          <ResultCard
            label="Current"
            value={getTotalsParallel().totalI.toFixed(1)}
            unit="A"
            variant="subtle"
            isDarkMode={isDarkMode}
          />
          <ResultCard
            label="Resistance"
            value={getTotalsParallel().totalR.toFixed(1)}
            unit="Ω"
            variant="subtle"
            isDarkMode={isDarkMode}
          />
          <ResultCard
            label="Power"
            value={getTotalsParallel().totalP.toFixed(1)}
            unit="W"
            variant="subtle"
            isDarkMode={isDarkMode}
          />
