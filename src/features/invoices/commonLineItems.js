// Common invoice line items for electrical services
export const COMMON_INVOICE_LINE_ITEMS = [
  // Service Calls & Fees
  'Service Call',
  ...
  // Labor Rates
  'Labor - Standard Rate',
  'Labor - Journeyman Rate',
  'Labor - Master Electrician Rate',
  'Labor - Apprentice Rate',
  'Labor - Overtime Rate',
  'Labor - Double Time Rate',
  'Labor - Holiday Rate',
  'Helper Labor',
  'Additional Labor',
  ...
  'GFCI Protection Upgrade',
  'AFCI Protection Upgrade',
...
// Function to get line items as objects (for potential Firebase storage)
export const getCommonLineItemsAsObjects = () => {
  return COMMON_INVOICE_LINE_ITEMS.map(description => ({
    description,
    defaultRate: 0, // No default rate - user sets their own
    usageCount: 0,
    isCommon: true
  }));
};