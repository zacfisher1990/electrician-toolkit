...
>
  ...
  <option value="750">750 kcmil</option>
        ...
        <div style={{ 
          ...
          <strong style={{ color: '#374151', display: 'block', marginBottom: '0.5rem' }}>Derating Required When:</strong>
          <ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#6b7280', fontSize: '0.875rem' }}>
            <li style={{ marginBottom: '0.25rem' }}>Ambient temperature exceeds 86°F (30°C)</li>
            <li style={{ marginBottom: '0.25rem' }}>More than 3 current-carrying conductors in raceway</li>
      ...
      <div style={{ background: '#1e293b', color: '#cbd5e1', padding: '1.5rem', borderBottomLeftRadius: '0.5rem', borderBottomRightRadius: '0.5rem', fontSize: '0.875rem' }}>
        ...
        <ul style={{ paddingLeft: '1.5rem', margin: 0 }}>
          ...
          <li style={{ marginBottom: '0.25rem' }}>310.15(B) - Adjustment factors for ambient temperature and bundling</li>
